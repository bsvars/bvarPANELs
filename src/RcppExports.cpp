...
// bvarPANEL
Rcpp::List bvarPANEL(const int& S, const Rcpp::List& prior, const Rcpp::List& starting_values, const int thin, const bool show_progress);
RcppExport SEXP _bvarPANELs_bvarPANEL(SEXP SSEXP, SEXP priorSEXP, SEXP starting_valuesSEXP, SEXP thinSEXP, SEXP show_progressSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(bvarPANEL(S, prior, starting_values, thin, show_progress));
...
static SEXP _bvarPANELs_ordinal_try(SEXP nSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
...
RcppExport SEXP _bvarPANELs_ordinal(SEXP nSEXP) {
    SEXP rcpp_result_gen;
    {
        Rcpp::RNGScope rcpp_rngScope_gen;
        rcpp_result_gen = PROTECT(_bvarPANELs_ordinal_try(nSEXP));
    }
...
RcppExport SEXP _bvarPANELs_RcppExport_registerCCallable() { 
    R_RegisterCCallable("bvarPANELs", "_bvarPANELs_ordinal", (DL_FUNC)_bvarPANELs_ordinal_try);
    R_RegisterCCallable("bvarPANELs", "_bvarPANELs_RcppExport_validate", (DL_FUNC)_bvarPANELs_RcppExport_validate);
    return R_NilValue;
}

static const R_CallMethodDef CallEntries[] = {
    {"_bvarPANELs_bvarPANEL", (DL_FUNC) &_bvarPANELs_bvarPANEL, 5},
    ...
    {"_bvarPANELs_ordinal", (DL_FUNC) &_bvarPANELs_ordinal, 1},
